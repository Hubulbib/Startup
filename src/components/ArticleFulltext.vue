<template>
  <article class="article">
    ...
    <div @click="isBodyHidden = !isBodyHidden" class="article__hide">
      <Icon icon="material-symbols:collapse-content" width="30" height="30" v-if="!isBodyHidden" />
      <Icon icon="material-symbols:expand-content" width="30" height="30" v-else />
      <span>{{ isBodyHidden ? 'Показать' : 'Скрыть'}}</span>

    </div>
    <TransitionGroup name="body">
      <div id="article-body-container" v-if="!isBodyHidden">
